...
const Features = () => {
  return (
    <section id="feature" className="w-full h-full flex flex-col items-center justify-center px-5 py-5 gap-10">
<h1 className="text-5xl max-sm:text-3xl ">Features</h1>
